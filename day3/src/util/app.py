...
doctor_logger = configure_logger("doctor", "doctor.log")
patient_logger = configure_logger("patient", "patient.log")
appointment_logger = configure_logger("appointment", "appointment.log")
app_logger = configure_logger("main", "main.log")
